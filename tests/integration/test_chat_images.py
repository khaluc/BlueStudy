...
def test_direct_image_no_review_and_owner_isolation(backend):
    ...
    payload = {'message':'What is in this image?', 'image_document_id':doc['id']}
    ...
    def vision(image, question, history):
